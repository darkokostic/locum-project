<nav class="col-lg-12 col-md-12 navbar navbar-default menu-nav-bar navbar_no_board locum-nav-bar hidden-xs" ng-if="checkForURLHeader()">
    <div class="container-fluid menu-bar menu-bar-locum">
        ...
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed hover-burger" data-toggle="collapse" data-target="#locum-desktop-navbar-collapse" aria-expanded="false">
        ...
        <div class="collapse navbar-collapse response-nav-bar-xs" id="locum-desktop-navbar-collapse" ng-init="init()" >
            ...
            <ul class="nav navbar-nav navbar_font navbar-right nav-bar-response-locum logging nav-bar-locum">
                ...
                <li class="@{{activeClassesForNavbar[3]}} navbar-locum-menu"><a href="/#!/locum" ng-click="clickToChangeHeader(0);clickToChangeActiveTabOnLocumNavbar(3)">Your Account</a></li>
    ...
    <div class="container menu-bar-2-locum col-xs-12 col-md-10 col-md-offset-2 col-lg-offset-1" ng-if="style2=='profile'" >
    ...
    <div class="container menu-bar-2-locum col-xs-12 col-md-10 col-md-offset-2 col-lg-offset-1" ng-if="style2=='find_a_job'">
        <ul class="nav nav-tabs border-nav-tabs-locum locum-nav-2">
            <li class="active menu-bar-2-active profile-btn-locum-menu" role="presentation"><a href="/#!/locum">Find a job</a></li>
        </ul>
    </div>
    <div class="container menu-bar-2-locum col-xs-12 col-md-10 col-md-offset-2 col-lg-offset-1" ng-if="style2=='myJob'">
        <ul class="nav nav-tabs border-nav-tabs-locum locum-nav-2">
    ...
    <div class="container menu-bar-2-locum col-xs-12 col-md-10 col-md-offset-2 col-lg-offset-1" ng-if="style2=='billing'">
        <ul class="nav nav-tabs border-nav-tabs-locum locum-nav-2">
        </ul>
    </div>
</nav>