<nav class="col-lg-12 col-md-12 navbar navbar-default menu-nav-bar navbar_no_board locum-nav-bar visible-xs" ng-if="checkForURLHeader()">
    <div class="container-fluid menu-bar menu-bar-locum">
        ...
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed hover-burger" data-toggle="collapse" data-target="#practice-mobile-navbar-collapse" aria-expanded="false">
        ...
        <div class="collapse navbar-collapse response-nav-bar-xs" id="practice-mobile-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar_font navbar-right logging nav-bar-locum">
                <li class="@{{activeClassesForNavbarPractice[4]}} navbar-locum-menu"><a href="/#!/practice" ng-click="clickToChangeHeaderPractice(0);clickToChangeActiveTabOnPracticeNavbar(4)">Your Account</a></li>
